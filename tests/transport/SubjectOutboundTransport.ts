...
import type { OutboundDidCommPackage, OutboundDidCommTransport } from '@credo-ts/didcomm'
...
export class SubjectOutboundTransport implements OutboundDidCommTransport {
