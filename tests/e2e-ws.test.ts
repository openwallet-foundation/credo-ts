...
import { closeAndDeleteWallet, getBaseConfig, waitForBasicMessage } from '../packages/core/tests/helpers'
...
describe('websockets with mediator', () => {
  ...
  test('Alice and Bob make a connection with mediator', async () => {
    ...
    bobAgent = new Agent(bobConfig.config, aliceConfig.agentDependencies)
