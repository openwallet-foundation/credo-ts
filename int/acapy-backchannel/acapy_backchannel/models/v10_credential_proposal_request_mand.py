...
T = TypeVar("T", bound="V10CredentialProposalRequestMand")
...
class V10CredentialProposalRequestMand:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v10_credential_proposal_request_mand = cls(
            connection_id=connection_id,
            credential_proposal=credential_proposal,
        ...
        v10_credential_proposal_request_mand.additional_properties = d
        return v10_credential_proposal_request_mand
