...
T = TypeVar("T", bound="CredentialDefinitionSendResults")


@attr.s(auto_attribs=True)
class CredentialDefinitionSendResults:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        credential_definition_send_results = cls(
            credential_definition_id=credential_definition_id,
        )

        credential_definition_send_results.additional_properties = d
        return credential_definition_send_results
