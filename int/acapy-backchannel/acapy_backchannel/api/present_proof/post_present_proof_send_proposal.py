...
from ...models.v10_presentation_proposal_request import V10PresentationProposalRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: V10PresentationProposalRequest,
) -> Dict[str, Any]:
    url = "{}/present-proof/send-proposal".format(client.base_url)
