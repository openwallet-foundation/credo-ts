...
AGENT_URL=$AGENT_URL AGENT_PORT=$AGENT_PORT AGENT_LABEL=$AGENT_LABEL WALLET_NAME=$WALLET_NAME WALLET_KEY=$WALLET_KEY PUBLIC_DID=$PUBLIC_DID PUBLIC_DID_SEED=$PUBLIC_DID_SEED .yarn/bin/yarn prod
