...
// })
// @ts-ignore
indy_sdk_1.default.setRuntimeConfig({ collect_backtrace: true });
var issue_credential = function (klm, credentialDefenitionId, connectionRecord) { return __awaiter(void 0, void 0, void 0, function () {
    var promise, credentialPreview;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                promise = new Promise(function (resolve) {
                    klm.events.on(core_1.CredentialEventTypes.CredentialStateChanged, function (_a) {
                        var payload = _a.payload;
                        return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_b) {
                                if (payload.credentialRecord.state === core_1.CredentialState.Done) {
...
exports.issue_credential = issue_credential;
