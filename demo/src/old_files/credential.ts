...
export const accept_credential_offer = async (annelein: Agent, connectionRecord: ConnectionRecord) => {
  annelein.events.on(CredentialEventTypes.CredentialStateChanged, async ({ payload }: CredentialStateChangedEvent) => {
...
export const issue_credential = async (
  klm: Agent,
  credentialDefinitionId: string,
  connectionRecord: ConnectionRecord
) => {
  klm.events.on(CredentialEventTypes.CredentialStateChanged, async ({ payload }: CredentialStateChangedEvent) => {
