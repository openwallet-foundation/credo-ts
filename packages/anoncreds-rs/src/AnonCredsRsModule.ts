...
import { AgentConfig, anonCredsVcDataIntegrityServiceSymbol } from '@credo-ts/core'
...
export class AnonCredsRsModule implements Module {
  ...
  public register(dependencyManager: DependencyManager) {
    ...
    dependencyManager
      .resolve(AgentConfig)
      .logger.warn(
        "The '@credo-ts/anoncreds-rs' module is experimental and could have unexpected breaking changes. When using this module, make sure to use strict versions for all @credo-ts packages."
      )
