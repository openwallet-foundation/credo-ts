...
import { Anoncreds, AnonCredsRsSymbol, IndySdk, IndySdkSymbol } from '../../types'
...
import { IndySdkRevocationService } from './AnonCredsRsRevocationService'

export class AnonCredsRsHolderService implements AnonCredsHolderService {
  private anoncreds: Anoncreds
  private indyRevocationService: IndySdkRevocationService

  public constructor(indyRevocationService: IndySdkRevocationService, @inject(AnonCredsRsSymbol) anoncreds: Anoncreds) {
