...
export interface DidCommLinkedAttachmentOptions {
  name: string
  attachment: DidCommAttachment
}

export class DidCommLinkedAttachment {
  public constructor(options: DidCommLinkedAttachmentOptions) {
  ...
  public attachment: DidCommAttachment
   ...
   * @returns the id
   */
  private getId(attachment: DidCommAttachment): string {
