...
// NOTE: ideally we don't export the BaseDidCommCredentialProtocol, but as the V1CredentialProtocol is defined in the
...
export { BaseDidCommCredentialProtocol } from './BaseDidCommCredentialProtocol'
