...
import type { DidCommOutboundWebSocketClosedEvent, DidCommOutboundWebSocketOpenedEvent } from './DidCommTransportEventTypes'
...
export class WsOutboundDidCommTransport implements OutboundDidCommTransport {
