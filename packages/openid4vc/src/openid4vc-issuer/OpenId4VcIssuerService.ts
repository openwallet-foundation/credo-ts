...
export class OpenId4VcIssuerService {
  ...
  public async createCredentialResponse(
    ...
    if ('interval' in signOptionsOrDeferral) {
      ...
      issuanceSession.transactionData = {
        ...
        credentialConfigurationId,
        credentialConfiguration,
        singleProof: !!parsedCredentialRequest.credentialRequest.proof,
      }
  ...
  public async createDeferredCredentialResponse(
    ...
    if ('interval' in signOptionsOrDeferral) {
      ...
      deferredCredentialResponse = vcIssuer.createDeferredCredentialResponse({
        credential: options.issuanceSession.transactionData.singleProof ? credentials.credentials[0] : undefined,
        credentials: !options.issuanceSession.transactionData.singleProof ? credentials.credentials : undefined,
      })
