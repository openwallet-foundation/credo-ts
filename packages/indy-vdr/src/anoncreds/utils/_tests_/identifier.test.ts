import {getLegacySchemaId, getLegacyCredentialDefinitionId, didFromSchemaId, didFromCredentialDefinitionId, indyVdrAnonCredsRegistryIdentifierRegex} from '../identifiers'
