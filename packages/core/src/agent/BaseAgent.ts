...
import type { MessagePickupModule } from '../modules/didcomm/message-pickup'
...
import { OutOfBandApi } from '../modules/didcomm/oob'
import { MediatorApi, MediationRecipientApi } from '../modules/didcomm/routing'
