import type { AgentContextProvider } from '@aries-framework/core'
...
import { DefaultAgentContextProvider } from '@aries-framework/core'
...
describe('DIDResolverService', () => {
  ...
  const adapter = new DIDResolverService(agentContextProvider, provider)
