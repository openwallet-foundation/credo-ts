...
import { canHandleMessageType, replaceLegacyDidSovPrefixOnMessage } from '../utils/messageType'
...
export class MessageReceiver {
  ...
  private async sendProblemReportMessage(
    ...
    if (canHandleMessageType(ProblemReportMessage, plaintextMessage['@type'])) {
