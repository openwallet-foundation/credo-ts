...
const agentConfig = getAgentConfig('Migration DidRecord 0.2-0.3')
...
describe('0.2-0.3 | Did', () => {
  ...
  describe('migrateDidRecordToV0_3()', () => {
    it('should fetch all records and apply the needed updates ', async () => {
      ...
      await testModule.migrateDidRecordToV0_3(agent)
