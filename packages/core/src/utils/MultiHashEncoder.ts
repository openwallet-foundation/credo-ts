...
export class MultiHashEncoder {
   ...
   * @returns a multihash
   */
  public static encode(data: Uint8ArrayBuffer, hashName: HashName): Uint8ArrayBuffer {
   ...
   */
  public static decode(data: Uint8ArrayBuffer): { data: Uint8ArrayBuffer; hashName: string } {
   ...
   */
  public static isValid(data: Uint8ArrayBuffer): boolean {
    try {
