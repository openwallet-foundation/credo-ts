 ...
 */
export class V3CredentialPreview {
  ...
  @Expose({ name: 'type' })
  @IsValidMessageType(V3CredentialPreview.type)
  @Transform(({ value }) => replaceLegacyDidSovPrefix(value), {
    toClassOnly: true,
  })
  public readonly type = V3CredentialPreview.type.messageTypeUri
  public static readonly type = parseMessageType('https://didcomm.org/issue-credential/3.0/credential-preview')
  ...
  public static fromRecord(record: Record<string, string>) {
    ...
    return new V3CredentialPreview({
      attributes,
    })
  }
}
