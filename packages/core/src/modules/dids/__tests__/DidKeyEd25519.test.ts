...
describe('DidKey', () => {
  describe('ed25519', () => {
    it('should correctly create a DidKey instance from public key bytes and ed25519 key type', async () => {
    ...
    it('should correctly create a DidKey instance from a base58 encoded public key and ed25519 key type', async () => {
    ...
    it('should return a valid did:key did document for the did', async () => {
      ...
      expect(didKey.didDocument).toEqual(didKeyEd25519Fixture)
    })
  })
})
