...
export const VERIFICATION_METHOD_TYPE_BLS12381G1_KEY_2020 = 'Bls12381G1Key2020'
 ...
 */
export function getBls12381G1Key2020({ key, id, controller }: { id: string; key: Key; controller: string }) {
 ...
 */
export function isBls12381G1Key2020(verificationMethod: VerificationMethod): verificationMethod is Bls12381G1Key2020 {
  return verificationMethod.type === VERIFICATION_METHOD_TYPE_BLS12381G1_KEY_2020
}
