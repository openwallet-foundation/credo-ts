...
import { isInstance, isString, ValidateBy, buildMessage } from 'class-validator'
 ...
 */
export function IsStringOrVerificationMethod(validationOptions?: ValidationOptions): PropertyDecorator {
  return ValidateBy(
    {
