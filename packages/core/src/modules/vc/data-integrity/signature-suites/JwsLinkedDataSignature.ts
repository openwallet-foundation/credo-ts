...
export class JwsLinkedDataSignature extends LinkedDataSignature {
   ...
   */
  public async sign(options: { verifyData: Uint8ArrayBuffer; proof: Proof }) {
  ...
  public async getVerificationMethod(options: { proof: Proof; documentLoader?: DocumentLoader }) {
    ...
    verificationMethod = typeof document === 'string' ? JsonEncoder.fromString(document) : document
 ...
 */
function _createJws(options: { encodedHeader: string; verifyData: Uint8ArrayBuffer }): Uint8ArrayBuffer {
