...
describe('OutOfBandInvitation', () => {
  ...
  describe('fromJson', () => {
    ...
    test('transforms legacy prefix message @type and handshake_protocols to https://didcomm.org prefix', async () => {
      const json = {
    ...
    test('should successfully transform if no handshake_protocols is present', async () => {
      const json = {
        '@type': 'did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/out-of-band/1.1/invitation',
        '@id': '69212a3a-d068-4f9d-a2dd-4741bca89af3',
        label: 'Faber College',
