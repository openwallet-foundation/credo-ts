...
export const zKmsKeyAgreementDecryptHpke = z.object({
  ...
  /**
   * The raw serialized encapsulated key (`enc`) generated by the sender. For the DHKEM(P-256)
   * suites this is the 65-byte uncompressed SEC1 point.
   */
  encapsulatedKey: zAnyUint8Array,
...
export type KmsKeyAgreementDecryptHpke = z.output<typeof zKmsKeyAgreementDecryptHpke>
...
export function isKmsKeyAgreementDecryptHpke(
  keyAgreement: KmsKeyAgreementDecryptOptions
): keyAgreement is KmsKeyAgreementDecryptHpke {
