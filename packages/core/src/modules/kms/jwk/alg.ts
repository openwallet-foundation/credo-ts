...
export function supportedAlgsForSigningKey(
 ...
 */
export function allowedAlgsForSigningKey(
  jwk: KmsJwkPrivate | Exclude<KmsJwkPublic, KmsJwkPublicOct>
): KnownJwaSignatureAlgorithm[] {
  const supportedAlgs = supportedAlgsForSigningKey(jwk)
...
export function assertAllowedAlgForSigningKey(
  jwk: KmsJwkPrivate | Exclude<KmsJwkPublic, KmsJwkPublicOct>,
  algorithm: KnownJwaSignatureAlgorithm
) {
  const allowedAlgs = allowedAlgsForSigningKey(jwk)
