...
import { V1BasicMessageProtocol } from '../V1BasicMessageProtocol'
...
describe('V1BasicMessageProtocol', () => {
  let basicMessageProtocol: V1BasicMessageProtocol
  ...
  beforeEach(() => {
    basicMessageProtocol = new V1BasicMessageProtocol()
  })
