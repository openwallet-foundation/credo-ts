...
export interface V1ProofProtocolConfig {
  // indyCredentialFormat must be a service that implements the `IndyProofFormat` interface, however it doesn't
  // have to be the IndyProofFormatService implementation per se.
  indyProofFormat: ProofFormatService<IndyProofFormat>
}

export class V1ProofProtocol extends BaseProofProtocol implements ProofProtocol<[IndyProofFormatServiceLike]> {
  private indyProofFormat: ProofFormatService<IndyProofFormat>
  ...
  public async getCredentialsForRequest(
    agentContext: AgentContext,
    { proofRecord, proofFormats }: GetCredentialsForRequestOptions<[IndyProofFormatServiceLike]>
  ): Promise<GetCredentialsForRequestReturn<[IndyProofFormatServiceLike]>> {
    if (proofFormats) this.assertOnlyIndyFormat(proofFormats)
  ...
  public async selectCredentialsForRequest(
    agentContext: AgentContext,
    { proofRecord, proofFormats }: SelectCredentialsForRequestOptions<[IndyProofFormatServiceLike]>
  ): Promise<SelectCredentialsForRequestReturn<[IndyProofFormatServiceLike]>> {
    if (proofFormats) this.assertOnlyIndyFormat(proofFormats)
  ...
  ): Promise<ProofProtocolMsgReturnType<V1PresentationAckMessage>> {
