...
export class ProofsApi {
  ...
  public async getByThreadAndConnectionId(threadId: string, connectionId?: string): Promise<ProofRecord> {
    return this.proofService.getByThreadAndConnectionId(this.agentContext, threadId, connectionId)
  }
  ...
  public async getByParentThreadAndConnectionId(parentThreadId: string, connectionId?: string): Promise<ProofRecord[]> {
    return this.proofService.getByParentThreadAndConnectionId(this.agentContext, parentThreadId, connectionId)
  }
