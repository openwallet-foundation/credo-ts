...
export interface LedgerModuleConfigOptions {
  /**
   * Whether to automatically connect to all ledgers on startup.
   ...
   * @default true
   */
  connectToLedgersOnStartup?: boolean
...
export class LedgerModuleConfig {
  ...
  /** See {@link LedgerModuleConfigOptions.connectToLedgersOnStartup} */
  public get connectToLedgersOnStartup() {
    return this.options.connectToLedgersOnStartup ?? true
  }
