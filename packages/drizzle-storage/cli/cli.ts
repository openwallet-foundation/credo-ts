      ...
      generate: {
        ...
        handler: async ({
          ...
          try {
            ...
            log('Migration generation completed successfully!')
          } catch (error) {
            errorLog('Error generating migrations:', error instanceof Error ? error.message : error)
            process.exit(1)
          }
        },
      },
      migrate: {
        ...
        handler: async ({
          ...
          try {
            ...
            log('Applying migrations completed successfully!')
          } catch (error) {
            errorLog('Error applying migrations:', error instanceof Error ? error.message : error)
            process.exit(1)
          }
        },
      },
      studio: {
        ...
        handler: async ({
          ...
          try {
            ...
            log('Drizzle Studio completed successfully!')
          } catch (error) {
            errorLog('Error running Drizzle Studio:', error instanceof Error ? error.message : error)
            process.exit(1)
          }
        },
      },
