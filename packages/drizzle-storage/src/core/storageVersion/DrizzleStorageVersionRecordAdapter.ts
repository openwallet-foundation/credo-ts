...
type DrizzleStorageVersionRecordAdapterValues = DrizzleAdapterValues<(typeof sqlite)['storageVersion']>
...
> {
  ...
  public getValues(record: StorageVersionRecord): DrizzleStorageVersionRecordAdapterValues {
    return {
