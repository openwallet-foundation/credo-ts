...
type DrizzleAnonCredsCredentialDefinitionPrivateAdapterValues = DrizzleAdapterValues<
...
> {
  ...
  public getValues(
    record: AnonCredsCredentialDefinitionPrivateRecord
  ): DrizzleAnonCredsCredentialDefinitionPrivateAdapterValues {
