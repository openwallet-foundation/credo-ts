...
type DrizzleAnonCredsKeyCorrectnessProofAdapterValues = DrizzleAdapterValues<
...
> {
  ...
  public getValues(record: AnonCredsKeyCorrectnessProofRecord): DrizzleAnonCredsKeyCorrectnessProofAdapterValues {
