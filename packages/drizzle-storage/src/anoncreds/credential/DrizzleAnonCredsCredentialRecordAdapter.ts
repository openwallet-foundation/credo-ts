...
type DrizzleAnonCredsCredentialAdapterValues = DrizzleAdapterValues<(typeof sqlite)['anonCredsCredential']>
...
> {
  ...
  public getValues(record: AnonCredsCredentialRecord): DrizzleAnonCredsCredentialAdapterValues {
    const {
      credentialId,
      linkSecretId,
