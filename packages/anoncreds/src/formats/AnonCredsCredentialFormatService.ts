...
export class AnonCredsCredentialFormatService implements CredentialFormatService<AnonCredsCredentialFormat> {
  ...
  public async createProposal(
    ...
    { credentialFormats, credentialRecord }: FormatCreateProposalOptions<AnonCredsCredentialFormat>
    ...
    const { attributes, linkedAttachments, ...indyCredentialProposal } = anonCredsFormat
  ...
  public async acceptProposal(
    agentContext: AgentContext,
    {
      ...
      credentialRecord,
      proposalAttachment,
    }: FormatAcceptProposalOptions<AnonCredsCredentialFormat>
  ): Promise<FormatCreateOfferReturn> {
    const indyFormat = credentialFormats?.anoncreds
  ...
  public async createOffer(
    agentContext: AgentContext,
    { credentialFormats, credentialRecord, attachId }: FormatCreateOfferOptions<AnonCredsCredentialFormat>
  ): Promise<FormatCreateOfferReturn> {
    const indyFormat = credentialFormats.anoncreds
  ...
  public async acceptOffer(
    agentContext: AgentContext,
    { credentialRecord, attachId, offerAttachment }: FormatAcceptOfferOptions<AnonCredsCredentialFormat>
  ...
  public async acceptRequest(
    agentContext: AgentContext,
    {
      ...
      offerAttachment,
      requestAttachment,
    }: FormatAcceptRequestOptions<AnonCredsCredentialFormat>
  ): Promise<CredentialFormatCreateReturn> {
